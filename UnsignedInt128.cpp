...
UnsignedInt128 ui64product(ui64 a, ui64 b) {
    ui64toui32 _a_, _b_, c = {0}, d = {0}, buff;                                // Result will have the form d·2^64 + c
    _a_._ui64_ = a; _b_._ui64_ = b;                                             // Cast from ui64 to ui32[2]

    c._ui64_    = (ui64)_a_._ui32 [0]*_b_._ui32[0];                             // Using the pencil and paper multiplication algorithm
    buff._ui64_ = (ui64)_a_._ui32 [0]*_b_._ui32[1] + c._ui32[1];                // ...
    c._ui32[1]  = buff._ui32[0];                                                // ...
    d._ui32[0]  = buff._ui32[1];                                                // ...
    buff._ui64_ = (ui64)_a_._ui32 [1]*_b_._ui32[0] + c._ui32[1];                // ...
    c._ui32[1]  = buff._ui32[0];                                                // ...
    buff._ui64_ = (ui64)_a_._ui32 [1]*_b_._ui32[1] + d._ui32[0] + buff._ui32[1];// ...
